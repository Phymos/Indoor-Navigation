...
Tech Stack
LayerTechnologyBackendPython, FlaskFrontendHTML, CSS, JavaScriptAlgorithmDijkstra (custom impl.)
...
Select a start room from the dropdown
Select a destination room
Click Yolu Bul — the shortest path animates on the map
